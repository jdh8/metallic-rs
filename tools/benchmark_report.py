...
STATIC_ESTIMATE = """## Static analysis
...
def render(directory):
    ...
    sections = [
        ...
        "Later [f64 optimization measurements](benchmarks/2026-09-05/f64-optimization/README.md) "
        "and [f32 optimization measurements](benchmarks/2026-09-05/f32-optimization/README.md) "
        "record subsequent improvements with paired before/after results.",
    ...
    sections.extend(("Regenerate this report from the committed snapshots:",
                     ...
                     "run, archived lock hashes, matching archived source manifests, and consumption of every "
