...
| `benchmark_snapshot.py` | Serial benchmark runner preserving estimates, source hashes, lock file and machine conditions; use a fresh output/target directory. | `benchmarks/` |
| `benchmark_report.py` | Historical September 5 report from the three archived host snapshots, with coverage and provenance checks. | `BENCHMARKS.md` |
