...
pub use f64_::{
    acos, acosh, asin, asinh, atan, atan2, atanh, cbrt, cos, cosh, cospi, erf, erfc, exp, exp2,
    exp10, expm1, fma, frexp, hypot, ldexp, lgamma, log, log1p, log2, log10, round, rsqrt, sin,
    sincos, sinh, sinpi, tan, tanh, tgamma,
};
...
pub use f32_::{
    acosf, acoshf, asinf, asinhf, atan2f, atanf, atanhf, cbrtf, cosf, coshf, cospif, erfcf, erff,
    exp2f, exp10f, expf, expm1f, fmaf, frexpf, hypotf, ldexpf, lgammaf, log1pf, log2f, log10f,
    logf, powf, roundf, rsqrtf, sincosf, sinf, sinhf, sinpif, tanf, tanhf, tgammaf,
};
