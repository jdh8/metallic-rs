...
bench!(bench_metallic, metallic::tan, bench::Exponents(-26..=19));
bench!(bench_core_math, core_math::tan, bench::Exponents(-26..=19));
bench!(bench_std, f64::tan, bench::Exponents(-26..=19));
bench!(bench_libm, libm::tan, bench::Exponents(-26..=19));
